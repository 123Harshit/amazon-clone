...
function Login() {
  ...
  const register = (e) => {
    ...
    auth
      ...
      .then((auth) => {
        //it has succesfully created a new user with email and password
        console.log(auth);
        if (auth) {
          history.push("/");
        }
  ...
  return (
    <div className="login">
      ...
      <div className="login__container">
        ...
        <p>
          By Signing-in you agree to the <strong>HARSHIT's</strong> FAKE AMAZON
          CLONE Conditions of the Use & Sale. Please see our Privacy Notice, our
